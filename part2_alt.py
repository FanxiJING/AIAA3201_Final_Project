...
Usage:
    ...
    python part2_alternative.py [--datasets waymo dl3dv re10k]
...
OUTPUT_ROOT = f"{WORKPLACE}/output/part2_alternative"
BASELINE    = f"{WORKPLACE}/output/part2_original"
...
def run_method(method_name, name, cfg, run_fn, run_kwargs):
    ...
    out    = f"{OUTPUT_ROOT}/{name}/{method_name}"
    model  = f"{out}/3dgs"
